...
export const apps: AppCard[] = [
  ...
  },
  {
    id: 'settings',
    name: 'Settings',
    description: 'Platform settings, access logs, and service configuration',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    id: 'forms-builder',
    name: 'Forms Builder',
    description: 'Build forms with data collection and verifiable credential verification',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    id: 'test-issuer',
    name: 'Test Issuer',
    description: 'Issue test credentials via Orbit LOB with QR code scanning',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
